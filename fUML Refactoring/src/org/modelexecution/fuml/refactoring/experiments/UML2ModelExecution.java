 ...
 * 
 */
public class UML2ModelExecution {
	...
	public void executeCallBehaviorActivity() {
		loadModel("models/extractSuperClass.uml"); //$NON-NLS-1$
		Trace trace = executeActivity("ExtractSuperClass"); //$NON-NLS-1$
