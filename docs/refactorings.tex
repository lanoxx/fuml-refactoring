...
Build on these common concepts models can be preserved over time and even be reused. Nevertheless models 
...
fUML is a subset of UML for which additional semantics are defined such that the model can be executed. fUML contains subsets 
