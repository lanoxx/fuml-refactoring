...
\begin{figure}
 \makebox[\textwidth]{
 \begin{tabular}{c | c}
  \includegraphics[scale=0.75]{images/encapsulate/Model_Model_EncapsulateProperty1} &
  \includegraphics[scale=0.75]{images/encapsulate/Model_Model_EncapsulateProperty2} \\
  \includegraphics[scale=0.65]{images/encapsulate/Activity_doSomething_DoSomething1} &
  \includegraphics[scale=0.65]{images/encapsulate/Activity_doSomething_DoSomething2}
 \end{tabular}
 }
