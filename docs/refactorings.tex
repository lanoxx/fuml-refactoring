...
Listing \ref{lst:resourceset} shows how a model can be initialized and loaded. The \texttt{Resource\-Set}
...
All elements contained in the model are instances of Ecore (the implementation of
