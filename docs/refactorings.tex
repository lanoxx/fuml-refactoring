...
\todo{it seems we are repeating our selfs about what we will present}.
...
addCar() in figure \ref{fig:addCar} and calculatePremium() figure \ref{fig:calculatePremium}.
