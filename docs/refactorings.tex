...
For this we use an example for the insurance domain. Figure X. \todo{reference insurance figure} shows the class diagram of an insurance policy.
...
are different (dangerousGoods, passengers).
